...
namespace Shababeek.Interactions.Core
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        /// </summary>
        public IObservable<VRButtonState> OnTriggerTriggerButtonStateChange => config?[hand]?.TriggerObservable;
        ...
        /// </summary>
        public float this[FingerName index] => config?[hand]?[index] ?? 0f;
        ...
        private void AutoAssignHandModel()
        {
            ...
            {
                handModel = handRenderer.gameObject;
            }
            else
            {
