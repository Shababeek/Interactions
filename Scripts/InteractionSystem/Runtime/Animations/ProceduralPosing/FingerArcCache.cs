...
namespace Shababeek.Interactions.Animations
{
    ...
    {
        private static readonly Dictionary<(EntityId controllerId, int poseIndex, int sampleCount), FingerArcs> Cache = new();
        ...
        public static FingerArcs Get(HandPoseController controller, HandFingerRig rig, int poseIndex, int sampleCount = 12)
        {
            ...
            var key = (controller.GetEntityId(), poseIndex, sampleCount);
