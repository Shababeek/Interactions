...
namespace Shababeek.Interactions.Editors
{
    ...
    public class SocketableEditor : Editor
    {
        ...
        private SerializedProperty socketableMaskProp;
        ...
        private void OnEnable()
        {
            ...
            socketableMaskProp = serializedObject.FindProperty("socketableMask");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(socketLayerMaskProp,
                new GUIContent("Socket Layer Mask", "Physics layers scanned during socket detection. Narrows the OverlapSphere query before category matching."));
            EditorGUILayout.PropertyField(socketableMaskProp,
                new GUIContent("Socketable Mask", "Categories this socketable belongs to. Matched against each socket's accepted mask via bitwise AND."));
            EditorGUILayout.Space();
