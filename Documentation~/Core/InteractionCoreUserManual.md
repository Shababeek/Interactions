...
The InteractionSystem Core provides the foundational components for VR hand interactions in Unity. This manual is **Editor-first**: configure **Config**, **Camera Rig**, and **Hand** components in the Inspector before relying on custom scripts. Code samples are optional additions after those basics work.

This system handles hand tracking, physics-based hand movement, input management, and camera rig setup.
